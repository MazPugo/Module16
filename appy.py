...
class db:
    def __init__(self):
        ...
        #upload individual files csv into variables
...
def transation_init():
    ...
    #Use the library os,  load all the files in the folder db\transactionsinto Pandas and link them together thanks to the function append.
...
def merge(self):
    #connect the transaction base with the appropriate product categories,
